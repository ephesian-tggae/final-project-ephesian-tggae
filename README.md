...
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=23929574)

> **MovieNest application:** code, setup, and project docs live in [`MovieNest-app/`](MovieNest-app/).  
> API: [`MovieNest-app/backend/`](MovieNest-app/backend/) · Documentation: [`MovieNest-app/docs/`](MovieNest-app/docs/) · Product brief: [`MovieNest-app/PRODUCT_BRIEF.md`](MovieNest-app/PRODUCT_BRIEF.md)
